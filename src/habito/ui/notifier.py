...
a system-tray message, a taskbar/dock alert, and a beep. Which of those actually land
depends on the desktop, hence all three rather than picking one.
...
class DesktopNotifier:
    def __init__(self, window: QWidget, enabled: bool = True) -> None:
        self._window = window
